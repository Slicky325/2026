...
This two-phase approach allows any query to access a summarized version of global information immediately, effectively eliminating the need for multi-hop propagation. The to a 11x speedup, as compared to normal self-attention. 
