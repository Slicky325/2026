...
{% include figure.liquid path="assets/img/2026-04-27-sparsity/6.png" class="img-fluid" caption="From the paper MInference 1.0: Accelerating Pre-filling for Long-Context LLMs via Dynamic Sparse Attention" %}
...
{% include figure.liquid path="assets/img/2026-04-27-sparsity/7.png" class="img-fluid" caption="From the paper MInference 1.0: Accelerating Pre-filling for Long-Context LLMs via Dynamic Sparse Attention" %}
...
{% include figure.liquid path="assets/img/2026-04-27-sparsity/8.png" class="img-fluid" caption="From the paper MInference 1.0: Accelerating Pre-filling for Long-Context LLMs via Dynamic Sparse Attention" %}
### XAttention
